...
## Ερώτημα 3b
Με τα παραπάνω αποτελέσματα παρατηρώ ότι το πρόγραμμα εκτελέστηκε γρηγορότερα με τον TimingSimpleCPU από ότι με τον MinorCPU. Ωστόσο η διαφορά είναι πολύ μικρή. Αυτό οφείλεται στο γεγονός ότι και τα 2 cpus είναι μοντέλα in-order cpus.
...
Η εργασία είχε ένα ιδιαίτερο ενδιαφέρον γιατί παρόλο που δουλέψαμε σε γνώριμα περιβάλλοντα με το terminal, η ενασχόληση με τον gem5 ήταν κάτι που δεν είχαμε κάνει στο παρελθόν. Μέσω αυτού του προσομοιωτή μπήκαμε στη διαδικασία να ψάξουμε λίγο παραπάνω πληροφορίες πάνω στο hardware του υπολογιστή μας. Ταυτόχρονα μάθαμε και πως ακριβώς δουλεύει το github, καθώς και να χρησιμοποιούμε τη γλώσσα Markdown που εκτός από το github, χρησιμοποιείται αρκετά σε ένα άλλο ιστότοπο που συνδεόμαστε, το reddit.  
Την εργασία δεν θα την χαρακτηρίζαμε απλοϊκή αλλά αντιθέτως έχει ένα σχετικό βαθμό δυσκολίας κυρίως λόγω του όγκου των νέων πληροφοριών. Αυτό οφείλεται όμως στο γεγονός ότι την κάναμε πριν γίνει το εργαστήριο μιας και δεν ήταν ξεκάθαρο μέχρι τότε πότε θα είναι η λήξη προθεσμίας, κάτι για το οποίο ελπίζουμε να είναι λίγο πιο ξεκάθαρα τα πράγματα την επόμενη φορά.
